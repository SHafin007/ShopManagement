...
namespace Shop.Controllers
{
    public class CountrieController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,regionId")] Country country)
        {
            ...
            ViewBag.regionId = new SelectList(db.Regions, "id", "name", country.regionId);
            return View(country);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,regionId")] Country country)
        {
            if (ModelState.IsValid)
            {
